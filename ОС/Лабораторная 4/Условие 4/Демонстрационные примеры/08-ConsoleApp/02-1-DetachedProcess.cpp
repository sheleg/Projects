// Пример процесса, который создает процесс без консоли,
// но устанавливает поля структуры STARTUPINFO
...
{
	char c;
	char lpszAppName[]="C:\\AllocateConsole.exe";
			...
			DETACHED_PROCESS, NULL, NULL, &si, &pi))
	{
		...
		cout<<"Press any char to finish."<<endl;
		cin>>c;
		return 0;
	}
