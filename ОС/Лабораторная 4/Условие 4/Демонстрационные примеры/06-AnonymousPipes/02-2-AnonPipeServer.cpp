...
// Сервер сначала читает из анонимного канала, а затем пишет в его.  
// Дескриптор анонимного канала передается клинету через командную строку. 
