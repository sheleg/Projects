        ...
        MouseMotionListener // For processing mouse drags
{
    ...
    private WitchOfAgnesi currentScribble; // The scribble in progress
    private WitchOfAgnesi beingDragged; // The scribble being dragged
    ...
    public void dragGestureRecognized(DragGestureEvent e) {
        ...
        for (WitchOfAgnesi witch : witches) { // Loop through the scribbles
    ...
    public void drop(DropTargetDropEvent e) {
        ...
        WitchOfAgnesi droppedScribble; // This will hold the Scribble object
        ...
        droppedScribble.translate((int) p.getX(), (int) p.getY()); // Move it there
        witches.add(droppedScribble); // add to display list
