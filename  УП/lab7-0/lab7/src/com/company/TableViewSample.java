...
public class TableViewSample extends Application {
    ...
    private final TableView<Department> table2 = new TableView<>();
    private static final ObservableList<Person> data1 = FXCollections.observableArrayList();
    private static final ObservableList<Department> data2 = FXCollections.observableArrayList();
    ...
    private static void connectionDB()
    {
        try {
            ...
            rst = connection.createStatement().executeQuery(SQL);

            while (rst.next()) {
                Person person = new Person(rst.getString("workerID"), rst.getString("fullname"),
                        rst.getString("age"), rst.getString("gender"),
                        rst.getString("position"), rst.getString("trackDepartment"));
                data1.add(person);
            }
            ...
            while (rst.next()) {
                Department dep = new Department(rst.getString("departmentID"), rst.getString("department_name"), rst.getString("description"));
                data2.add(dep);
            }
    ...
    public static void CreateDB()
    {
        try {
            ...
            statmt.execute("CREATE TABLE if not exists 'workers' ('workerID' INTEGER PRIMARY KEY AUTOINCREMENT, 'fullname' text, " +
    ...
    public void start(Stage stage) {
        ...
        TableColumn<Person, String> idCol =
                new TableColumn<>("ID");
        idCol.setPrefWidth(30);
        idCol.setMaxWidth(30);
        idCol.setCellValueFactory(
                new PropertyValueFactory<>("id"));
        idCol.setCellFactory(TextFieldTableCell.<Person>forTableColumn());
        ...
        TableColumn<Person,String> trackDepartmentCol =
        ...
        table1.getColumns().addAll(idCol, fullnameCol, ageCol, genderCol, positionCol, trackDepartmentCol);
        ...
        table2.getColumns().addAll(DepartmentCol, DepNameCol, DepInfoCol);
        ...
        hb.getChildren().addAll(addFullName, addAge, addGender, addPosition, addTrackDepartment, addButton);

        final VBox vbox = new VBox(10);
        vbox.setPadding(new Insets(10, 0, 0, 10));
        vbox.getChildren().addAll(label, table1, table2, hb);
